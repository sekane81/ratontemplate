<div id="buddypress">
	...
	<form action="" method="post" id="forums-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="forums-all"><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_forums_root_slug() ); ?>"><?php printf( __( 'All Topics <span>%s</span>', 'T20' ), bp_get_forum_topic_count() ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) ) : ?>

					<li id="forums-personal"><a href="<?php echo trailingslashit( bp_loggedin_user_domain() . bp_get_forums_slug() . '/topics' ); ?>"><?php printf( __( 'My Topics <span>%s</span>', 'T20' ), bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li id="forums-order-select" class="last filter">
					...
					<label for="forums-order-by"><?php _e( 'Order By:', 'T20' ); ?></label>
					<select id="forums-order-by">
						<option value="active"><?php _e( 'Last Active', 'T20' ); ?></option>
						<option value="popular"><?php _e( 'Most Posts', 'T20' ); ?></option>
						<option value="unreplied"><?php _e( 'Unreplied', 'T20' ); ?></option>
