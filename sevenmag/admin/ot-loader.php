    ...
    public function global_admin_css() {
      ...
      <style>
        @font-face {
          ...
          src:url("' . get_template_directory_uri() . '/admin/assets/fonts/option-tree-font.eot");
          src:url("' . get_template_directory_uri() . '/admin/assets/fonts/option-tree-font.eot?#iefix") format("embedded-opentype"),
            url("' . get_template_directory_uri() . '/admin/assets/fonts/option-tree-font.woff") format("woff"),
            url("' . get_template_directory_uri() . '/admin/assets/fonts/option-tree-font.ttf") format("truetype"),
            url("' . get_template_directory_uri() . '/admin/assets/fonts/option-tree-font.svg#option-tree-font") format("svg");
          font-weight: normal;
          font-style: normal;
        }
        #adminmenu #toplevel_page_ot-settings .menu-icon-generic div.wp-menu-image:before,
