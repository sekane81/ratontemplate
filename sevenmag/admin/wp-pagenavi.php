...
/*function pagenavi_menu() {
	if (function_exists('add_menu_page')) {
		add_options_page(__('PageNavi', 'T20'), __('PageNavi', 'T20'), 'manage_options', 'wp-pagenavi/pagenavi-options.php') ;
	}
}*/
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = ot_get_option('nav_page_tr');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = ot_get_option('nav_first_tr');
	$pagenavi_options['last_text'] = ot_get_option('nav_last_tr');
