			<?php if ( ot_get_option( 'head_pos' ) === 'head4' ) : $head4 = 'e_center'; else : $head4 = ''; endif; ?>
			<div class="head head_t <?php echo $head4; ?>">
				...
				<div class="tt_nav <?php if ( ot_get_option( 'sticky' ) === 'on' ): ?>my_sticky<?php endif; ?>">
					<div class="row clearfix">
						<nav id="mymenuone">
