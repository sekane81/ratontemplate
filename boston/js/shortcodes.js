(function($) {
	...
	if( typeof tinymce != 'undefined' ){
	    tinymce.create('tinymce.plugins.boston', {
	        init : function(ed, url) {
	        	instance = ed;        	
				ed.addButton('bostongrid', {
					type: 'listbox',
					text: 'Boston Grid',
					icon: false,
					onselect: function(e) {
				...
				/* elements */
				ed.addButton('bostonelements', {
					type: 'listbox',
					text: 'Boston Elements',
					icon: false,
					onselect: function(e) {
						active_shortcode = this.value();
						call_shortcode();
	    ...
	    // Register plugin
	    tinymce.PluginManager.add( 'boston', tinymce.plugins.boston );
	}
})(jQuery);
