...
$_ts_caption = get_post_meta($ts_page_id, '_page_titlebar_caption', true);
...
?>
            <div id="title-bar-wrap" class="title-bar-layout-normal title-bar-page <?php echo esc_attr($page_photo_class);?>" style="<?php echo esc_attr($page_photo_css);?>">
