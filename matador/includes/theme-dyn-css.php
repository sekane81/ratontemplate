...
?> 
    ...
    h1,
    #title-bar h2,
    #main-slider-wrap.flexslider-wrap h2 { font-size: <?php echo esc_attr($h1_font_size);?>; <?php echo aq_font_style($h1_font_style);?> }
    ...
    ?>
    /* top container */
    .top-stuff-side { color: <?php echo esc_attr($top_container_font_color);?>; }
    .top-stuff-side a { color: <?php echo esc_attr($top_container_link_color);?>; }
    .top-stuff-side a:active,
    .top-stuff-side a:focus,
    .top-stuff-side a:hover { color: <?php echo esc_attr($top_container_link_hover_color);?>; }
    ...
    #top-bar { color: <?php echo esc_attr($top_bar_text_color);?>; }
    ...
    .main-nav > div > ul > li.current_page_ancestor > a > .sf-sub-indicator { color: <?php echo esc_attr($main_nav_hover_color);?>; }
    ...
    .main-nav > div > ul > li.current_page_ancestor > a:after { background-color:<?php echo esc_attr($main_nav_hover_color);?>; }
